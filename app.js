...
app.put('/products/:id', authenticate, (req, res) => { 
    ...
    db.query('UPDATE Product SET ProductName = ?, Description = ?, Price = ?, Stock = ?, CategoryID = ?, ImageURL = ? WHERE ProductID = ?',
    [ProductName, Description, Price, Stock, CategoryID, ImageURL, ProductID], (err, result) => { 
    if (err) throw err; 
